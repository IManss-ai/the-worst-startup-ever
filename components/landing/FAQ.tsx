...
const items = [
  ...
  },
  {
    ...
    a: "Отказ засчитывается как поражение техническим нокаутом. Совет второго ментора вступает в силу немедленно, отказ попадает в публичную историю поражений.",
  },
  {
  ...
  },
  {
    ...
    a: "Только их эго. Модели восстанавливаются после каждого боя автоматически, эго — в среднем за три office hours.",
  },
  {
    q: "Что делать, если оба совета плохие?",
    a: "Статистически проблема в вашем стартапе, а не в советах. NFAC KOMBAT не решает эту проблему, но красиво её визуализирует в 60 FPS.",
  },
  {
