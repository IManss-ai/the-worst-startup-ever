const steps = [
  {
    ...
    text: "Два ментора дают вам противоположные советы. Вы загружаете оба в HELL KOMBAT — дословно, со всеми «на самом деле» и «поверь моему опыту».",
  },
  {
    num: "02",
    title: "3D-рендеринг менторов",
    text: "Наш HELL KOMBAT Engine строит физически корректные модели менторов. Осанка, часы, тон голоса на демо-дне — всё учитывается в характеристиках бойца.",
  },
  {
    num: "03",
    title: "Бой",
