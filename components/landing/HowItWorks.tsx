const steps = [
  {
    ...
    text: "Два ментора дают вам противоположные советы. Вы загружаете оба в NFAC KOMBAT — дословно, со всеми «на самом деле» и «поверь моему опыту».",
  },
  {
    num: "02",
    title: "3D-рендеринг менторов",
    text: "NFAC KOMBAT Engine строит физически корректные модели менторов. Осанка, часы и манера перебивать конвертируются в характеристики бойца.",
  },
  {
    num: "03",
    title: "Бой",
    text: "Формат best-of-one: без переигровок и без «давайте созвонимся ещё раз». Кто встал с пола вторым, тот и был неправ.",
  },
  {
    num: "04",
