const testimonials = [
  ...
  {
    quote:
      "Мой ментор из глобального акселератора проиграл локальному ментору апперкотом на 47-й секунде. Мы сделали пивот в тот же вечер. Никаких сожалений — решение принял не я.",
    name: "Дана",
    role: "ко-фаундер маркетплейса",
  },
  {
    quote:
      "NFAC KOMBAT закрыл наш главный blocker на пути к product-market fit: необходимость думать.",
    name: "Тимур",
